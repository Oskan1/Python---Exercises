import pickle  # create for serializing python objects, but all the objects have to be loaded back in pc memory, thats why we
# use shelve module
...
with open("imelda.pickle", "wb") as pickle_file:         #write binary "wb"
